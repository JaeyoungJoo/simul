...
if not st.session_state["authenticated"]:
    ...
    try:
        ...
        if last_activity_cookie:
            # Update only if 60 seconds passed (to avoid too many cookie writes)
            if current_time - float(last_activity_cookie) > 60:
                 cookie_manager.set("last_activity", str(current_time), expires_at=expires_at, key="set_last_activity_update")
        else:
             cookie_manager.set("last_activity", str(current_time), expires_at=expires_at, key="set_last_activity_init")
    except:
        pass
                        ...
                        for t in v:
                            ...
                            if "Tier" in t:
                                ...
                                loaded_tiers.append(TierConfig(
                                    ...
                                    demotion_mmr=t.get("demotion_mmr", 0.0),
                                    points_win=t.get("points_win", 0),
                                    points_draw=t.get("points_draw", 0),
                                    points_loss=t.get("points_loss", 0),
                                    ...
                                    promotion_mmr_2=t.get("promotion_mmr_2", 0.0),
                                    promotion_mmr_3=t.get("promotion_mmr_3", 0.0),
                                    promotion_mmr_4=t.get("promotion_mmr_4", 0.0),
                                    promotion_mmr_5=t.get("promotion_mmr_5", 0.0),
            ...
            if new_tier_df is not None:
                try:
                    ...
                    numeric_cols = [
                        ...
                        "promotion_points", "promotion_points_low", "promotion_points_high",
                        "promotion_mmr_2", "promotion_mmr_3", "promotion_mmr_4", "promotion_mmr_5",
                        "match_count", "demotion_point", "demotion_point_low", "demotion_point_high", "tier_group",
